...
export const changelogEntries: Record<number, ChangelogPost> = {
    ...
    2: {
        ...
        content: [
            ...
            "If you want to learn more about how we're making Blinq Campus safer for you, check out our new blog post.",
        ],
    },
    3: {
