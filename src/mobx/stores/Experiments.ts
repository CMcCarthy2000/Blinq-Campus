...
export const EXPERIMENTS: {
    ...
    offline_users: {
        ...
        description:
            "If you can take the performance hit - for example, if you're on desktop - you can re-enable offline users for big servers such as the Blinq Campus Lounge.",
    },
    plugins: {
    ...
    admin_beta: {
        ...
        description:
            "Adds context menu entries to quickly jump to the Blinq Campus Admin Panel. This is intended for use by the team.",
    },
};
